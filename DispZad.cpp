...
// DispZad.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDispZadApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CDispZadApp

CDispZadApp::CDispZadApp()
{
...
// Единственный объект CDispZadApp

CDispZadApp theApp;


// Инициализация CDispZadApp

BOOL CDispZadApp::InitInstance()
{
